"""
Step 10 — Per-ticker SV-ADF volatility analysis.
...
Usage
-----
    python scripts/10_volatility_analysis.py               # all tickers
    python scripts/10_volatility_analysis.py --tickers NVDA AMD GOOGL
    python scripts/10_volatility_analysis.py --window W2   # pre-ChatGPT
    python scripts/10_volatility_analysis.py --vol-window 20  # 4-week vol
"""
