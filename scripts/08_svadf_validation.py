"""
Step 8 — SV-ADF standalone validation on historical bubble episodes.
...
Usage
-----
    python scripts/08_svadf_validation.py
    python scripts/08_svadf_validation.py --case NASDAQ_dotcom
    python scripts/08_svadf_validation.py --M 360 --R 180 --bridge 720
"""
