"""
Step 9 — SV-ADF sector-panel summary figures.
...
Usage
-----
    python scripts/09_svadf_sector_panels.py          # all segments
    python scripts/09_svadf_sector_panels.py --segments "1. Semiconductor Equipment"
    python scripts/09_svadf_sector_panels.py --show    # display interactively
"""
