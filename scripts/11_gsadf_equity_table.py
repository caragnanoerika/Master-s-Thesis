"""
Step 11 — GSADF results table for individual equities.
...
Output
------
    outputs/tables/gsadf_equity_results.csv   ← copy-paste into Excel/Word
    outputs/tables/gsadf_equity_results.tex   ← paste directly into LaTeX

Usage
-----
    python scripts/11_gsadf_equity_table.py
"""
...
def main() -> None:
    ...
    # CSV
    csv_path = settings.TABLES_DIR / "gsadf_equity_results.csv"
    df.to_csv(csv_path, index=False)
    print(f"CSV  → {csv_path}")

    # LaTeX
    tex_path = settings.TABLES_DIR / "gsadf_equity_results.tex"
