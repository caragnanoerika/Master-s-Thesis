...
Output: outputs/figures/fig_stationarity.png
"""
import json
import sys
...
OUT_FILE = settings.FIGURES_DIR / "fig_stationarity.png"
...
def make_figure(rows):
    ...
    unique_segs = []
    for s in segments:
        if not unique_segs or unique_segs[-1] != s:
